...
public class MahasiswaDao {
    ...
    /**
     * Konstruktor default (untuk runtime normal)
     * Mengambil koneksi dari KoneksiPool.
     */
    public MahasiswaDao() {
        this(() -> {
            try {
                return KoneksiPool.getConnection();
    ...
    /**
     * Konstruktor khusus untuk testing atau koneksi kustom.
     * @param connectionSupplier pemasok koneksi (misalnya dari H2 di test)
     */
    public MahasiswaDao(Supplier<Connection> connectionSupplier) {
